...
import com.ryan.videoplayer.player.OnInitializedCallback;
import com.ryan.videoplayer.player.PlayerController;
    ...
    private SurfaceHolder.Callback previewCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            if (isFirst) {
                ...
                String path = "/sdcard/DCIM/Camera/ROKIDVIDEO_20200403_2021_47363968394.mp4";
